...
contract OracleSetUP is Test {
    ...
    function setUp() public virtual {
        ...
        ftsoV2.setFeedData(ETH_USD_FEED_ID, ETH_USD_FTSO_PRICE, FTSO_DECIMALS, uint64(block.timestamp));

        ftsoV2.setFeedData(BTC_USD_FEED_ID, BTC_USD_FTSO_PRICE, FTSO_DECIMALS, uint64(block.timestamp));
    }
